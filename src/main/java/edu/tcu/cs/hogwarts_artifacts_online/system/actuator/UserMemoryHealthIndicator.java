...
@Component
public class UserMemoryHealthIndicator implements HealthIndicator {
    ...
    public Health health() {
        ...
        return Health
                .status(status)
                .withDetail("usable memory", diskUsableInBytes)// In addition to reporting the status, we can attach additional key-value details using the withDetails(key,value)
