...
public class ArtifactController {
    ...
    public Result findAllArtifacts(Pageable pageable) {
        ...
        // Convert artifactPage to a page of artifactsDtos
    ...
    @GetMapping("/summary")
    public Result summaizeResult() throws JsonProcessingException {
    ...
    @PostMapping("/images")
    public Result uploadImage(@RequestParam String containerName, @RequestParam MultipartFile file) {
        try (InputStream inputStream = file.getInputStream()) {
            String imageUrl = this.imageStorageClient.uploadImage(containerName, file.getOriginalFilename(),
